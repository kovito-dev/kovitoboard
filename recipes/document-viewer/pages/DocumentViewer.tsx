  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0 }} data-testid="docviewer">
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden', minHeight: 0 }}>
        {/* Left pane: file list */}
        <div style={{ width: '240px', flexShrink: 0, overflowY: 'auto', borderRight: '1px solid var(--border)' }}>
          {listError && (
            <div className="p-3">
        ...
        {/* Right pane: content */}
        <div style={{ flex: 1, minWidth: 0, overflowY: 'auto', padding: '1rem' }} data-testid="docviewer-content">
          {isReadLoading && (
