    ...
    <div data-testid="onboarding-step-project" className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className="px-3 py-2 rounded-lg border border-[var(--border)] bg-[var(--bg-surface)] text-[var(--text-primary)] placeholder:text-[var(--text-dim)] focus:outline-none focus:ring-2 focus:ring-[var(--onboarding-accent)]"
        />
        {nameError && (
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          ...
          rows={4}
          className="px-3 py-2 rounded-lg border border-[var(--border)] bg-[var(--bg-surface)] text-[var(--text-primary)] placeholder:text-[var(--text-dim)] focus:outline-none focus:ring-2 focus:ring-[var(--onboarding-accent)] resize-none"
        />
      ...
      <div className="flex justify-between pt-4">
        ...
        <button
          ...
          onClick={onNext}
          disabled={!isValid}
          className="px-4 py-2 bg-[var(--onboarding-accent)] text-white rounded-lg hover:bg-[var(--onboarding-accent-hover)] disabled:opacity-50 transition-colors"
        >
          {t('onboarding.next')}
        </button>
      </div>
