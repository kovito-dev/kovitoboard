...
// Q11 / SM-4: keep onboarding aligned with the settings-modal cap.
// Architect §6.9 specifies 1MB for the operator avatar; the agent
// avatar (different surface) keeps the legacy 2MB budget.
