...
Give the user a quick mental model of KovitoBoard: what it is, what the main screens are, the core vocabulary, and how master settings work. This is the chapter a first-time user lands on.
