...
> ⚠️ This is a draft (v0.1). The file will be placed at `templates/agents/secretary.en.md` in the KB repository. Designed to be customized by the user (name, personality, tone).
...
Changes are applied to the corresponding section of the system prompt. Details: `docs/agent-ref/02-agents.md` §4.
...
- `docs/agent-ref/INDEX.md` → locate the right chapter
...
- Deeper integration with task management (v0.1.1 TaskCreate-family features)
- Calendar integration (v0.2.0)
- Cross-agent coordination tasks (v0.2.0)
